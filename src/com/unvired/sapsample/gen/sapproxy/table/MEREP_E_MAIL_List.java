...
public class MEREP_E_MAIL_List extends Table
{
	...
	static
	{
		...
		METADATA.setProxyClass("com.unvired.sapsample.gen.sapproxy.table.MEREP_E_MAIL_List");
		METADATA.setProxyRecClass("com.unvired.sapsample.gen.sapproxy.record.MEREP_E_MAIL");
